...
PROMPT=$'%(?:%{\e[1;31m%}U M B R E L L A %{\e[1;97m%}☣%{\e[0m%} :%{\e[1;31m%}U M B R E L L A %{\e[1;31m%}☣ %{\e[0m%})%{\e[1;90m%}%~$(git_prompt_info)\
%{\e[1;38;5;236m%}>%{\e[1;38;5;238m%}>%{\e[1;38;5;241m%}> %{\e[0m%} '

ZSH_THEME_GIT_PROMPT_PREFIX=$'%{\e[1;90m%} ⋅%{\e[1;31m%}'
ZSH_THEME_GIT_PROMPT_SUFFIX=$'%{\e[0m%}'

ZSH_THEME_GIT_PROMPT_DIRTY=$'%{\e[1;90m%}⋅%{\e[1;97m%}✿'
